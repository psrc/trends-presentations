...
bls_dt[(variable == "weekly_wages" & qtr == 1), month := "mar"]
bls_dt[(variable == "weekly_wages" & qtr == 2), month := "jun"]
bls_dt[(variable == "weekly_wages" & qtr == 3), month := "sep"]
bls_dt[(variable == "weekly_wages" & qtr == 4), month := "dec"]
